    ...
    <header id="header">
        ...
        <div class="container">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                ...
                <a href="/booking" class="btn btn-medium btn-outline-primary btn-pill text-uppercase">Book Now</a>
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <a class="nav-link text-dark active p-0 mt-3 mt-lg-0" aria-current="page" href="/">Home</a>
                </li>
                <li class="nav-item ps-4 pe-4 border-right">
                ...
                <li class="nav-item ps-4 pe-4 border-right">
                <a class="nav-link text-dark p-0" href="/booking">Booking</a>
                </li>
                <li class="nav-item ps-4 pe-4 border-right">
    ...
    <!-- end header -->
<?php /**PATH C:\xampp\htdocs\medical_healthcare\resources\views/includes/header.blade.php ENDPATH**/ ?>