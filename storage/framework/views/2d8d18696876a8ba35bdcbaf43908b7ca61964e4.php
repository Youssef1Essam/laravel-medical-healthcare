   ...
   <footer id="footer" class="overflow-hidden padding-large pb-0">
    ...
    <div class="row d-flex flex-wrap justify-content-between">
        ...
        <div class="footer-menu">
            <img src="images/logo-main.png" alt="logo" class="pb-3">
...
<!-- footer end -->
<?php /**PATH C:\xampp\htdocs\medical_healthcare\resources\views/includes/footer.blade.php ENDPATH**/ ?>